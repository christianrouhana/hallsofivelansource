...
class Action:
    ...
    def perform(self) -> None:
        """perform this aciton with objects needed to determine its scope
...
class PickupAction(Action):
    """pickup item and add to inventory if there is room"""
...
class ActionWithDirection(Action):
    ...
    def blocking_entity(self) -> Optional[Entity]:
        """Return the blocking entity at this actons destination"""
...
# practically the same as MeleeAction, implemented for expandability
